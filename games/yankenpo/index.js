...
function win(user, computer) {
    ...
    result_div.innerHTML = `<p>${convertCase(user)}${userName} gana a ${convertCase(computer)}${compName}. Ganaste!</p>`;
...
function loses(user, computer) {
    ...
    const userName = ' (user)'.fontsize(3).sup();
    const compName = ' (comp)'.fontsize(3).sup();
    result_div.innerHTML = `<p>${convertCase(computer)}${compName} gana a ${convertCase(user)}${userName}. Perdiste!</p>`;
    const roundStatus = document.getElementById(user);
